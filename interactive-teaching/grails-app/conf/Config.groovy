...
grails.plugins.springsecurity.interceptUrlMap = [
    ...
    '/answer/edit/**': [ 'ROLE_TEACHER', 'ROLE_STUDENT' ],
    '/answer/save': [ 'ROLE_TEACHER', 'ROLE_STUDENT' ],
    '/answer/create': [ 'ROLE_TEACHER', 'ROLE_STUDENT' ],
    '/answer/update/**': [ 'ROLE_TEACHER', 'ROLE_STUDENT' ],
    '/answer/delete/**': [ 'ROLE_TEACHER' ],
    '/question/show/**': [ 'ROLE_TEACHER', 'ROLE_STUDENT' ],
    '/question/edit/**': [ 'ROLE_TEACHER' ],
    '/question/save': [ 'ROLE_TEACHER' ],
    '/question/create': [ 'ROLE_TEACHER' ],
    '/question/update/**': [ 'ROLE_TEACHER' ],
    '/question/delete/**': [ 'ROLE_TEACHER' ],
    '/session/**': [ 'ROLE_TEACHER' ],
    '/vote/**': [ 'ROLE_STUDENT' ],
